...
func databaseFeedsoFeeds(dbFeeds []database.Feed) []Feed {
	feeds := []Feed{}
...
func databaseFeedFollowsToFeedFollows(dbFeedFollows []database.FeedFollow) []FeedFollow {
	...
	for _, v := range dbFeedFollows {
		feedFollows = append(feedFollows, databaseFeedFollowToFeedFollow(v))
	}
...
func databasePostToPost(dbPost database.Post) Post {
	...
	if dbPost.Description.Valid { // 如果不为空则设置为dbPost.Description.String
